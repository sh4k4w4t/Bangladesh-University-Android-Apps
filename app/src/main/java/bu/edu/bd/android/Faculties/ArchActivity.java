...
public class ArchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headImage.setImageResource(R.drawable.head_arch);
        textOfHeadMessage.setText(getResources().getText(R.string.messgaeofArchDept));
        aboutBtn.setOnClickListener(view -> BrowserLinkSetupForMath("https://bu.edu.bd/about-department-of-architecture/"));
        ...
        syllabusBtn.setOnClickListener(view -> BrowserLinkSetupForMath("https://bu.edu.bd/faculties/faculty-of-science-engineering-technology/architecture/proposed-course-curriculum-for-arch-dept/"));
        facultyBtn.setOnClickListener(view -> BrowserLinkSetupForMath("https://bu.edu.bd/faculties/faculty-of-science-engineering-technology/architecture/member-of-the-faculty/"));
    }
