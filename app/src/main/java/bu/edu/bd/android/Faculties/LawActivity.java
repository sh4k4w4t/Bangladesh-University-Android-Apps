...
public class LawActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Department of Law");
        ...
        headImage.setImageResource(R.drawable.law_head);
        textOfHeadMessage.setText(getResources().getText(R.string.messageOfLaw));
        ...
        syllabusBtn.setOnClickListener(view -> BrowserLinkSetupForMath("https://bu.edu.bd/faculties/faculty-of-arts-sociology-law/department-of-law/syllabus-of-law-department/"));
        facultyBtn.setOnClickListener(view -> BrowserLinkSetupForMath("https://bu.edu.bd/faculty-members-of-law-department/"));
    }
